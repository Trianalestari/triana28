             ...
             <div class="row">
              <div class="col-lg-6">
                ...
                <a href="" class="btn btn-primary mb-3"
                  data-toggle="modal" data-target="#newSubMenuModal">Add Menu</a>
                    <!-- Tabel -->
...
<div class="modal fade" id="newSubMenuModal" tabindex="-1" aria-labelledby="newMenuModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog" rple="document"> 
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabelsubedit">Add new SubMenu</h5>
